...
import FeedbackDashBoard from 'aminer/p/user/c/NotifiicationComponentN/component/dashboard/feedbackDashBoard';
...
const RecommendsPaper = (props: Proptypes) => {
  ...
  return (
    <div
      className={classnames(styles.RecommendsPaper, { [styles.isHotPaper]: hotPaper })}
      ref={divRef}
      data-id={paper?.id}
      onClick={() => {
        if (sendPingBack) {
    ...
    >
      {hotPaper && <div className={styles.hotPaper} />}
      {/* , { [styles.hotPaper]: hotPaper } */}
      
      {labels && (
        <div className="legendAndKeywords">
          <div className={classnames('legend')}>{legend}</div>
      ...
      <div className="paperContent">
        ...
        <div className="paper">
          ...
          {isExpandFeedback ? (
            <React.Fragment>
              <div className={styles.selectedBtnHr}>
